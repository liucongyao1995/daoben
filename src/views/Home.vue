    ...
    <swiper id="swiperBox" v-bind:options="swiperOption" ref="mySwiper">
      <swiper-slide class="swiper-slide slide-one">
        <!-- <div class="page">
         ...
         <p class="slogan">专注女性生殖生命力健康与婚姻幸福文化传播</p>
      </swiper-slide>
      ...
      <swiper-slide class="swiper-slide slide-two">
        ...
        <div class="page1">
          ...
          <p>
            以普及女性健康管理、女性生殖抗衰、美臀抗衰、情感教育、婚姻幸福等系列营销品牌
            教育为主，传播女性健康美丽文化，缔造幸福女性为宗旨，打造女性由内而外的身、心、灵
            生殖生命力健康管理机构。
          </p>
          <p>
            公司注重产品的专业化与高品质，每一款产品都经过严格的临床实验和成熟的市场验证
            才引进，推出适合女性群体的生殖抗衰产品。
          </p>
          <p>
            公司以全新的人性化管理制度，凝聚了多名优秀的科研、生产技术和管理人才，拥有强
...
// }
.slide-one {
  background: url(../assets/img/fuben.png) no-repeat center;
  background-size: 1310px 909px;
}
.slide-two {
